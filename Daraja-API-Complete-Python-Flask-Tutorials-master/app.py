...
def init_stk():
    ...
    # Set up callback URL
    my_endpoint = base_url + "/stkpush"
    
    # Business details and timestamp
    business_shortcode = "174379"
    passkey = "bfb279f9aa9bdbcf158e97dd71a467cd2e0c893059b10f78e6b72ada1ed2c919"
    timestamp = datetime.now().strftime("%Y%m%d%H%M%S")
    
    # The password for the STK Push request
    ...
    data = {
        ...
        "PartyA": "0716094501", # fill with your phone number
        "PartyB": "174379",
        "PhoneNumber": "0716094501", # fill with your phone number
...
def _access_token():
    global consumer_key, consumer_secret  # Reference global variables
    endpoint = 'https://sandbox.safaricom.co.ke/oauth/v1/generate?grant_type=client_credentials'
